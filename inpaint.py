...
samples = [
    (
        ...
        "the cherries dropping smartly into the pail",
    ),
    (
        "260",
        "260_123288_000041_000003",
        ...
        "instruments, the tools, our guns, are clashing",
    ),
    (
        "908",
        "908_157963_000004_000000",
        "Does the Eagle know what is in the pit? Or wilt thou go ask the Mole: Can Wisdom be put in a silver rod? Or Love in a golden bowl?",
        "the Mole: Can Wisdom be",
    ),
    (
        "1089",
        "1089_134691_000049_000002",
        "To live, to err, to fall, to triumph, to recreate life out of life!",
        "to triumph, to recreate life",
    ),
    (
        "1188",
        "1188_133604_000024_000001",
        ...
        "subject is in deep shadow, the eye",
    ),
    (
        "1320",
        "1320_122612_000043_000001",
        ...
        "instant, instead of sounding an alarm, which",
    ),
    (
        "1580",
        "1580_141084_000029_000002",
    ...
    (
        ...
        "touches of life and some of its warmth",
    ),
    (
        "2961",
        "2961_961_000022_000000",
    ...
    (
        ...
        "there is also a more frequent attendance at large",
    ),
    (
        "3575",
        "3575_170457_000012_000003",
        "He spoke French perfectly, I have been told, when need was; but delighted usually in talking the broadest Yorkshire.",
        "perfectly, I have been told, when need",
    ),
    (
        "4970",
        "4970_29095_000056_000000",
        ...
        "glad to hear that Philip had made a push into",
    ),
    (
        "4992",
        "4992_23283_000048_000000",
        ...
        'him, and cried, "But, my Lord, how shall I',
    ),
    (
        "5683",
        "5683_32879_000008_000001",
        ...
        "dressed, and this moment coming down",
    ),
    (
        "6829",
        "6829_68769_000009_000000",
        ...
        "settled with the victim of the forged check",
    ),
    (
        "6930",
        "6930_81414_000019_000003",
        "Gradually I knew I was mastering him--then all was blank.",
        "mastering him--then all was",
    ),
    (
        "7176",
        "7176_92135_000006_000007",
        '"My dear Sir," I should reply (or Madam), "you have come to the right shop.',
        'or Madam), "you have come to the right shop',
    ),
    (
        "8455",
        "8455_210777_000003_000000",
        ...
        "hours, but I must acknowledge that before I left",
    ),
    (
        "8463",
        "8463_294828_000014_000001",
        ...
        "by the Botanical Gardens, my dearly",
    ),
    (
        "8555",
        "8555_292519_000004_000000",
        ...
        "gardens intimate with hollyhocks, Where",
    ),
]


def emphasize(s: str, t: str) -> str:
    b = html_escape(s).replace(
        html_escape(t), "<u><em><strong>" + html_escape(t) + "</strong></em></u>"
    )
    return b


def get_table(
    root: str = "/ardit-web/samples/inpaint",
